...
public class BrotherPrinter extends CordovaPlugin {
    ...
    public boolean execute (String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if ("getLabelInfo".equals(action)) {
            getLabelInfo(args, callbackContext);
            return true;
        }
    ...
    private class DiscoveredPrinter {
        ...
        public DiscoveredPrinter(JSONObject object) throws JSONException {
            ...
            System.out.println("BROTHER TESTING PAPERSIZE");
    ...
    private void setPrinter(JSONArray args, final CallbackContext callbackctx) {
        try {
            ...
            editor.putString("paperSize", LabelInfo.QL700.W29.toString());
            editor.commit();
    ...
    private void initializePrinter(final JSONArray args, final CallbackContext callbackctx) {
        SharedPreferences sharedPreferences = PreferenceManager
                .getDefaultSharedPreferences(cordova.getActivity());
